...
const PostDetail = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm dark:border dark:border-gray-800">
      {/* Header */}
      <div className="mb-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 flex-1">
            {post.title}
          </h1>
        ...
        <div className="flex items-center gap-4 text-sm text-gray-400 dark:text-gray-400 mt-4">
      ...
      {/* Content */}
      <div
        className="prose max-w-none text-gray-800 dark:text-gray-100 leading-relaxed"
